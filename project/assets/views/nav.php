...
=======
                ...
                <button class="btn_remove btn_transparent btn_nav"><i class='bx bx-rename'></i></button>
                <button class="btn_remove btn_transparent btn_nav"><i class='bx bx-move-horizontal'></i></button>
            </div>
